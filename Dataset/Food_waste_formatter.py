...
for i in range(len(trimmed)):
    ...
    for j in range(i+1, len(trimmed)):
        ...
        new_batch_carb = round(row_a['Carbohydrate.Perc']*5 + row_b['Carbohydrate.Perc']*5, 5)
        new_batch_protein = round(row_a['Protein.Perc']*5 + row_b['Protein.Perc']*5, 5)
        new_batch_fat = round(row_a['Fat.Perc']*5 + row_b['Fat.Perc']*5, 5)
        ...
        new_continuous_carb = round(row_a['Carbohydrate.Perc']*37 + row_b['Carbohydrate.Perc']*37, 5)
        new_continuous_protein = round(row_a['Protein.Perc']*37 + row_b['Protein.Perc']*37, 5)
        new_continuous_fat = round(row_a['Fat.Perc']*37 + row_b['Fat.Perc']*37, 5)
