...
switch model
    case 'ADM1'
        ...
        std = readtable('structures\feed_inputs\inputs_csv\11_grass_silage.csv')
        % Solve ODE of mass-based ADM1
        ode = ode15s(@(t,x) ADM1_mass(t,x,system.Variables,std.Variables,parameters.ADM1.Variables),time_range,initial.ADM1.Variables);
...
%% Clear variables 
>>>>>>> 491b5c33a6c039be4b62dc9e6cf2b27a74051f93
